...
[![go report card](https://goreportcard.com/badge/github.com/tysonheart/burrow)](https://goreportcard.com/report/github.com/tysonheart/burrow)
[![Coverage Status](https://coveralls.io/repos/github/tysonheart/burrow/badge.svg?branch=master)](https://coveralls.io/github/tysonheart/burrow?branch=master)
[![GoDoc](https://godoc.org/github.com/tysonheart/burrow?status.svg)](https://godoc.org/github.com/tysonheart/burrow)
...
### Build and Install
```
$ go get github.com/tysonheart/burrow
$ cd $GOPATH/src/github.com/tysonheart/burrow
$ dep ensure
$ go install
```
...
### Configuration
For information on how to write your configuration file, check out the [detailed wiki](https://github.com/tysonheart/burrow/wiki)
